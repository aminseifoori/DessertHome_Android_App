...
public class dbhelper extends SQLiteOpenHelper{
	...
	private static String DB_PATH = "/data/data/com.ampesoftware.desserthome/databases/";
	 
	private static String DB_NAME = "Dessert";
	...
	private void copyDataBase() throws IOException{
		...
		public String listitems(int fieldindex,int recordindex, int groupinx){
		...
		public void favset(int ff, int idx){
			ContentValues cv=new ContentValues();
			cv.put("Fav",ff);
			myDataBase.update("Dessert", cv, "_id="+idx , null);
		}
